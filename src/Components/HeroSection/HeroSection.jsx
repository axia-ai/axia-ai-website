  ...
  return (
    <div className="relative bg-cover bg-center" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className="flex flex-col items-center justify-center h-full bg-black bg-opacity-5 text-white px-8 py-8 lg:py-20">
        ...
        <h1 className="text-3xl lg:text-5xl font-bold text-introHeadingBlack">Re-Imagine your business with innovative AI strategies and solutions by harnessing the latest in AI Technology to drive growth, efficiency, and scalability.</h1>

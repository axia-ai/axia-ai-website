  ...
  return (
    <>
        <div className="flex justify-between items-center bg-custom_purple text-white max-md:flex-col-reverse  my-10">
            <div className=" flex flex-col w-3/4 p-10 justify-center items-center max-sm:px-0 text-center">
                <h1 className=" text-4xl font-poppins mb-4 max-sm:text-2xl ">FOR YOUR VACATION</h1>

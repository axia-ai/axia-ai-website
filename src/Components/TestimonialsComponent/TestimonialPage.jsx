  ...
  return (
    <>
      <Testimonial
        ...
        clientQuote={"Axia's expert consultation on computer vision enabled us to successfully automate our waste sorting process."}
      />
      <Testimonial
        image={testimonial2}
        imagePosition={"right"}
        ...
        clientQuote={"Axia successfully developed a Gen-AI powered mobile app for Japanese users. We're now collaborating on the next phase of this project."}
      />
      <Testimonial
        image={testimonial3}
        imagePosition={"left"}
        ...
        clientQuote={"Axia, our trusted tech partner, successfully automated our workflows, resulting in an 85% reduction in operational time."}
      />
      <Testimonial
        image={testimonial4}
        imagePosition={"right"}
        ...
        clientQuote={"Axia's team successfully implemented a CRM system and automated our sales pipeline, providing on-demand support and training our team on CRM usage. This streamlined our operations and improved overall efficiency."}
      />
      <Testimonial
        image={testimonial4}
        imagePosition={"left"}
        testimonialHeading={"Website for Online Supper Club bookings and E-Commerce Store to sell Vegan products."}
        ...
        clientQuote={"Axia successfully developed an online store for my supper club bookings and created a visually appealing ecommerce platform to sell my vegan products. Their knowledge transfer was invaluable, and I thoroughly enjoyed working with them."}
      />
      <Testimonial
        image={testimonial4}
        imagePosition={"right"}
        ...
        clientQuote={"Axia's skilled tech team redesigned and redeveloped our fintech platform, creating a visually stunning and user-friendly interface."}
      />
       <Testimonial
        image={testimonial4}
        imagePosition={"left"}
        ...
        clientQuote={"Axia's tech team provided exceptional support in revamping my client's website, delivering a professional and effective result."}
      />
      <Testimonial
        image={testimonial4}
        imagePosition={"right"}
        ...
        clientQuote={"Axia's expert team developed a customized SEO data analytics dashboard and provided comprehensive support for our website development and tech consulting needs."}
      />
    </>
  );
}

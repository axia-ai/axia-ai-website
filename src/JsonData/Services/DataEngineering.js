...
export const FirstDeck = [
  {
    title: "Data Ingestion and Extraction",
    description: "We assist in extracting data from various sources, including databases, APIs, and files, and integrate it into a centralized data warehouse or data lake. This ensures that all relevant data is accessible for analysis and reporting.",
    icon: GoDatabase,
    linkAddress: ""
  },
  {
